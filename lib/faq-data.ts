...
export const FAQ_ITEMS: FaqItem[] = [
  {
    question: "What is a family court accountant?",
    answer:
      "A family court accountant is a forensic accountant who provides independent financial analysis and expert witness evidence in family proceedings, including divorce financial remedy, Schedule 1 Children Act claims, TOLATA cohabitation disputes, and nuptial agreement analysis. They bridge accounting and family law, translating complex financial information into clear evidence the court can rely on.",
  },
  {
    question: "What is Form E and why does a forensic accountant review it?",
    answer:
      "Form E is the mandatory financial disclosure document in financial remedy proceedings, covering all assets, income, pensions, liabilities, and outgoings of both parties. A forensic accountant reviews Form E and supporting documents, particularly business accounts, to identify whether disclosure is complete and whether figures are accurate and consistent with other available information.",
  },
  {
    question:
      "What is the difference between a Single Joint Expert and a party-appointed expert in family proceedings?",
    answer:
      "A Single Joint Expert (SJE) is appointed by the court and jointly instructed by both parties, producing one report for the court. Their duty is to the court, not either party. A party-appointed expert is instructed by one side only, typically reserved for very high-value or highly contested cases where parties' financial positions diverge significantly.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A standard case typically takes 3 to 5 months from appointment to final report, including document collection, financial analysis, draft report, and written questions. Urgent or expedited cases may be completed in 4 to 8 weeks depending on complexity and court timetable.",
  },
];
