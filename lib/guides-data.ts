...
export const GUIDES: Guide[] = [
  {
    ...
    metaTitle:
      "Business Valuation in Divorce | Guide for Solicitors and Individuals",
    metaDescription:
      "How family courts value businesses in divorce: personal vs business goodwill, maintainable earnings, liquidity, joint expert appointment, and expert witness standards expert evidence.",
    h1: "Business Valuation in Divorce: A Complete Guide for Solicitors and Individuals",
    aboutServiceId: "#business-valuation",
    sections: [
      {
        heading: "Why business valuation matters in financial remedy",
        paragraphs: [
          "When one or both spouses own a company, partnership interest, or substantial shareholding, the value of that interest is often the largest item in the matrimonial pot. Financial remedy proceedings require full disclosure on financial affidavit, but the figure a spouse places on their business is frequently disputed. A family court accountant provides independent analysis so the court can rely on maintainable earnings, appropriate valuation methods, and matrimonial adjustments rather than management estimates alone.",
          "For solicitors, early identification of valuation need supports expert witness standards applications and agreement of a court-appointed joint expert before costs escalate. For individuals, understanding that matrimonial valuation differs from a commercial sale price helps set realistic expectations: the court is concerned with fair value in the context of division, liquidity to fund a settlement, and what is truly available rather than a headline multiple from the company's own adviser.",
        ],
      },
      {
      ...
      {
        heading: "court-appointed joint expert appointment and court use of valuations",
        paragraphs: [
          "In most financial remedy cases below the highest value, the court directs a court-appointed joint expert accountant jointly instructed by both parties. A joint letter of instruction sets questions: value as at a date, personal goodwill treatment, maintainable earnings, and liquidity. Written questions after the report clarify assumptions before FDR or final hearing.",
          "The court uses valuation evidence alongside equitable distribution factors factors: needs, resources, and fairness. Valuation is rarely the only issue, but it anchors negotiation. Incomplete disclosure may trigger lifestyle analysis or hidden asset work in parallel. Instructing a qualified family court accountant early reduces the risk of agreed orders based on undervalued interests or unrealistic payment terms.",
        ],
      },
      {
        heading: "Working with your solicitor and expert costs",
        paragraphs: [
          "Attorneys remain responsible for case strategy, court applications, and settlement structure. The accountant's role is technical: value, liquidity, and adjustments. Joint expert appointments often share forensic accounting work between parties when the court directs a single expert.",
          "Individuals should discuss funding with their solicitor: Legal Aid, private costs, or contribution from the other party via court order may apply. Transparent scoping in the joint letter avoids scope creep and repeated supplemental reports. Contact us for scope; early contact helps match the right expert to the size and complexity of the business interests involved.",
        ],
      },
    ],
  },
  {
    ...
    metaTitle:
      "Hidden Assets in Divorce | How Family Court Accountants Investigate",
    metaDescription:
      "Common ways spouses conceal assets in divorce, forensic investigation methods, financial affidavit cross-checks, lifestyle analysis, and what courts can do about non-disclosure.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Hidden assets include bank accounts, investments, property interests, business values, cryptocurrency, and income streams that are not fully disclosed on financial affidavit or are deliberately undervalued. Non-disclosure may be omission, false statements, or structuring through trusts, family members, or offshore entities. The duty of full and frank disclosure is ongoing; assets disposed of before or during proceedings may still be traced and brought back into consideration.",
      ...
      {
        heading: "financial affidavit cross-referencing and documentary review",
        paragraphs: [
          "financial affidavit is the starting point: every section is compared to exhibits and third-party data. Bank statements reveal unexplained transfers, round-sum payments to connected parties, and accounts not listed in Section 2. Business accounts are tested against tax returns, payroll, and dividends declared on financial affidavit. Property schedules are checked against Land Registry and mortgage statements.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Overseas work has practical limits: local law, enforcement, and cost. Experts prioritise lines of enquiry with documentary proof bundle and identify what further disclosure orders are needed. Cooperation with forensic IT specialists may be required for email and ledger data in larger cases.",
        ],
      },
      {
  ...
  },
  {
    ...
    hubLabel: "financial affidavit disclosure",
    title: "financial affidavit Financial Disclosure: A Guide for Individuals",
    metaTitle:
      "financial affidavit Financial Disclosure | Guide for Individuals Going Through Divorce",
    metaDescription:
      "What financial affidavit requires in financial remedy, how family court accountants review disclosure, key sections to scrutinise, and how questionnaires challenge incomplete figures.",
    h1: "financial affidavit Financial Disclosure: A Guide for Individuals Going Through Divorce",
    aboutServiceId: "#form-e-review",
    sections: [
      {
        heading: "What financial affidavit is and when you must complete it",
        paragraphs: [
          "financial affidavit is the court's financial statement in divorce and dissolution financial remedy proceedings. Each party must disclose assets, income, pensions, liabilities, and monthly outgoings in a structured document with supporting exhibits. The form is lengthy and technical; mistakes or omissions can delay proceedings and damage credibility before a judge.",
          "If you are an individual going through divorce, you will usually complete financial affidavit with your solicitor after the conditional order stage, alongside your spouse's financial affidavit. The exchange is mutual: you see their disclosure and they see yours. A family court accountant can review your spouse's financial affidavit and documents to check whether figures are complete and consistent, not to replace your solicitor's advice on law or strategy.",
          "The court expects continuing disclosure: material changes after financial affidavit exchange may need to be reported. Your solicitor will explain timing. Understanding financial affidavit early helps you gather exhibits and reduces last-minute stress when deadlines are tight.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "After financial affidavit exchange, parties may send a questionnaire demanding further information and documents. Accountant-prepared questions are precise: identify account X, explain transfer Y, provide management accounts for period Z. Good questions save court time and reduce evasive answers.",
          "If responses remain inadequate, you may need a court direction for specific disclosure or forensic expert evidence. financial affidavit review is often the first step before hidden asset investigation or business valuation is funded.",
        ],
      },
      {
        heading: "Business accounts and self-employed income",
        paragraphs: [
          "Self-employed spouses control how salary, dividends, and benefits are reported. financial affidavit should match tax returns and company filings, but timing differences and add-backs through the business are common disputes. Accountants compare director remuneration with industry norms and with the lifestyle the family led.",
          "If you relied on joint spending during marriage that far exceeded what financial affidavit now shows as income, that gap is a red flag worth professional review. Notional income and add-back arguments may follow in the expert report.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "You need a solicitor to run proceedings; the accountant works as expert or adviser behind the scenes. Costs for financial affidavit review are typically lower than full forensic investigation and help decide whether deeper work is justified. Contact us if you want help understanding your spouse's financial affidavit before negotiation or court.",
        ],
      },
      {
        heading: "Pensions, debts, and future needs on financial affidavit",
        paragraphs: [
          "Pension CE values on financial affidavit should be supported by recent provider illustrations. Mismatches between financial affidavit and provider documents are common and affect offsetting negotiations. Debts must be evidenced: personal loans, credit cards, and director loans need statements, not estimates alone.",
      ...
      },
      {
        ...
        paragraphs: [
          "Many cases settle after financial affidavit and questionnaire rounds when weaknesses in disclosure are clear. Mediation and private FDR rely on the same figures as court. Individuals should avoid informal agreements before understanding the disclosed position; undervalued business interests or missed pensions are difficult to revisit later.",
          "If proceedings continue, expert reports may follow financial affidavit review. Keeping your own financial affidavit accurate reduces adverse findings against you and speeds the process. Your solicitor coordinates timing so accountant work aligns with court directions and without-prejudice discussions.",
          "First Appointment and Directions hearings may fix timetables for valuation and replies to questionnaire. Missing deadlines can mean proceeding with incomplete information, so individuals should respond promptly when their solicitor requests documents to support challenges to the other party's financial affidavit.",
        ],
      },
    ],
  },
  {
    ...
    metaTitle:
      "Schedule 1 Children Act Financial Evidence | Family Court Accountant Guide",
    metaDescription:
      "Schedule 1 child support statutes financial provision: income assessment, capital orders, business valuation, lifestyle evidence, and expert reports for unmarried parents.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Financial remedy on divorce divides the matrimonial pot between spouses under the equitable distribution statutes. Schedule 1 focuses on provision for the child: property may revert to the payer when the child grows up, and adult needs of the applicant are secondary. Costs rules and procedure differ from pure matrimonial cases.",
      ...
      },
      {
        ...
        paragraphs: [
          "expert witness standards applies in Schedule 1 proceedings in the Family Court. court-appointed joint experts are common for income and business issues. Letters of instruction should specify the child's circumstances, the orders sought, and the period for analysis.",
          "Solicitors should bundle financial affidavit equivalent disclosure, tax returns, company accounts, and bank statements. Early accountant involvement clarifies whether Schedule 1 is viable compared with other routes such as CMS assessments alone. See our Schedule 1 proceedings page for FAQs and related services.",
        ],
      },
      {
  ...
  },
  {
    ...
    metaTitle:
      "TOLATA Cohabitation Financial Guide | Solicitor's Guide to Trust of Land Evidence",
    metaDescription:
    ...
    sections: [
      ...
      {
        heading: "CPR Part 35 rather than expert witness standards",
        paragraphs: [
          "TOLATA claims in civil courts follow CPR Part 35 for expert evidence, not expert witness standards. Duties to the court remain paramount, but procedure, report format, and joint instruction rules follow civil practice. Experts who only work in family courts must adapt to CPR directions and possibly different timetables.",
  ...
  },
  {
    ...
    hubLabel: "expert witness standards",
    title: "expert witness standards and Expert Appointment in Family Proceedings",
    metaTitle:
      "expert witness standards Expert Appointment | Solicitor's Guide to Family Court Accountants",
    metaDescription:
      "expert witness standards forensic accountant appointment: court permission, joint expert vs party-appointed, joint letters, written questions, Daubert duties, and hearing attendance.",
    h1: "expert witness standards and Expert Appointment in Family Proceedings: A Solicitor's Guide",
    sections: [
      {
        heading: "Role of expert witness standards in family finance cases",
        paragraphs: [
      ...
      {
        heading: "court-appointed joint expert vs party-appointed expert",
        paragraphs: [
          "The default in most financial remedy cases is a court-appointed joint expert: one accountant, one report, costs usually shared equally. The court favours this approach to control expense and conflicting opinions. Party-appointed experts may be permitted in high-value or highly polarised cases where separate instructions are justified.",
          "joint expert instruction requires a joint letter signed by both parties' solicitors. Party-appointed experts receive separate letters but still owe the court the same duties. Experts must decline instructions that compromise independence or fall outside forensic accounting competence.",
      ...
      },
      {
        ...
        paragraphs: [
          "The joint letter defines proceedings, parties, questions, assumptions, documents provided, fee cap, and timetable. Vague questions produce vague reports and fertile ground for written questions later. Standard bundles include financial affidavit and exhibits, company accounts, tax returns, bank statements, and property valuations.",
          ...
          "Attach court orders granting permission and any directions on timetable. Reference the case number and parties consistently with financial affidavit to avoid administrative confusion when multiple family matters run in parallel.",
        ],
      },
      {
        heading: "Written questions, meetings, and oral evidence",
        paragraphs: [
          "After the report is served, parties may put written questions under expert witness standards for clarification of methodology, data, or arithmetic. Answers form part of the evidence. Experts may be required at FDR without prejudice discussions indirectly through their figures, and at final hearing for oral evidence and hot-tubbing where ordered.",
          "Preparation includes a statement of oral evidence, familiarity with both parties' positions, and adherence to Daubert duties: independent, transparent, and within expertise. Cross-examination targets assumptions; robust reports anticipate reasonable challenges.",
        ],
      },
      {
        heading: "Choosing and instructing the right accountant",
        paragraphs: [
          "Select experts with demonstrable family court experience, expert witness standards report samples, and understanding of matrimonial goodwill and financial affidavit. Civil fraud specialists without family practice may misunderstand disclosure culture and settlement dynamics.",
      ...
      },
      {
        ...
        paragraphs: [
          "expert witness standardsB expects clear separation of facts, assumptions, and opinion. Family court accountants set out documents reviewed, limitations where disclosure was incomplete, and ranges where appropriate. Arithmetic errors undermine credibility; quality control is essential before service.",
