...
export default function CaseTypesHubPage() {
  return (
    <PageShell
      ...
      title="Case Types Requiring a Family Court Accountant UK"
      subtitle="Ten common financial scenarios in UK family proceedings where forensic accountants provide expert analysis, reports, and court evidence."
    >
