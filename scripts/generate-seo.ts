 ...
 *
 * The URL list comes from lib/seo/publicUrlInventory.ts (buildPublicUrlInventory).
 * After adding static routes to APP_STATIC_PATHS, regenerate and run seo:verify.
 */
